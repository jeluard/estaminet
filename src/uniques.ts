...
export class Uniques {
  ...
  /**
   * @returns all `Collection`'s identifiers
   */
...
export class Collection {
   ...
   */
  async allItemIds(): Promise<Array<number>> {
...
export class Item {
  ...
  collection(): Collection {
    return new Collection(this.api, this.collectionId);
  }
  ...
  approveTransfer(delegate: string): SubmittableExtrinsic<any, any> {
    return this.api.tx.uniques.transferOwnership(
      this.collectionId,
      this.id,
      delegate
    );
  ...
  cancelApproval(checkDelegate?: string): SubmittableExtrinsic<any, any> {
    return this.api.tx.uniques.cancelApproval(
      this.collectionId,
      this.id,
      checkDelegate
    );
   ...
   */
  setMetadata(data: Bytes, isFrozen: boolean): SubmittableExtrinsic<any, any> {
    return this.api.tx.uniques.setMetadata(
      this.collectionId,
      this.id,
      data,
      isFrozen
   ...
   */
  setAttribute(key: Bytes, value: Bytes): SubmittableExtrinsic<any, any> {
    return this.api.tx.uniques.setAttribute(
      this.collectionId,
      this.id,
      key,
      value
  ...
  setPrice(
    ...
    return this.api.tx.uniques.setPrice(
      this.collectionId,
      this.id,
      price,
      whitelistedBuyer
